...
function mapGeneralRemarks(rawText) {
	...
	const lines = block
		...
		.filter(l => !/Any\s+other\s+information\s+which\s+in\s+your\s+opinion\s+Gatehouse\s+Bank\s+plc\s+should\s+note\s*:/i.test(l));
...
module.exports = { mapGeneralRemarks };
